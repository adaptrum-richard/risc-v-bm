...
static volatile uint32 *e1000_base_regs;

struct spinlock e1000_lock, e1000_lock_recv;

void e1000_init(uint32 *regs)
{
    int i;
...
int e1000_transmit(struct mbuf *m)
{
    ...
    //
    acquire(&e1000_lock);
    uint32 index = e1000_base_regs[E1000_TDT];
    ...
    e1000_base_regs[E1000_TDT] = (index + 1) % TX_RING_SIZE;
    release(&e1000_lock);
    return 0;
}
...
static void e1000_recv(void)
{
    ...
    while (1)
    {
        uint32 index = e1000_base_regs[E1000_RDT];
        ...
        e1000_base_regs[E1000_RDT] = index;
    }
}
...
void e1000_intr(void)
{
    ...
    e1000_base_regs[E1000_ICR] = 0xffffffff;
    __sync_synchronize();
    e1000_recv();
